...
import StudentTranscriptManagement from '@/components/features/students/StudentTranscriptManagement';
...
export default function ProprietorDashboard() {
    ...
    return (
        <div className="grid">
            ...
            {/* TabView for Dashboard Sections */}
            <div className="col-12">
                <TabView activeIndex={activeIndex} onTabChange={(e) => setActiveIndex(e.index)}>
                    {/* Dashboard Overview Tab */}
                    <TabPanel header="Dashboard Overview" leftIcon="pi pi-chart-line mr-2">
                        <div className="grid">
                                ...
                                >
                                    <div className="flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <div className={`font-bold text-2xl ${dashboardData.financial.netCashFlow >= 0 ? 'text-blue-700' : 'text-orange-700'}`}>
                                                {formatCurrency(dashboardData.financial.netCashFlow, dashboardData.financial.currency)}
                                            </div>
                                            <small className="text-500">Income - Expenses</small>
                                        </div>
                                        <div
                                            className={`flex align-items-center justify-content-center ${dashboardData.financial.netCashFlow >= 0 ? 'bg-blue-500' : 'bg-orange-500'} text-white border-round`}
                    ...
                    <TabPanel header="Student Transcripts" leftIcon="pi pi-file mr-2">
                        <StudentTranscriptManagement schoolId={user?.school} schoolSiteId={user?.schoolSite} />
                    </TabPanel>
                </TabView>
            </div>
        </div>
