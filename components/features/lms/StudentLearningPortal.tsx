...
import VideoPlayer, { VideoProgressState } from '@/components/common/VideoPlayer';
import { PdfViewerProps } from '@/components/common/PdfViewer';
...
const PdfViewer = dynamic<PdfViewerProps>(() => import('@/components/common/PdfViewer'), {
    ssr: false,
    loading: () => (
