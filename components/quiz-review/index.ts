...
} from '@/lib/lms/quiz-review-types';

// Re-export configuration objects
export { violationTypeConfig, attemptStatusConfig, gradingStatusConfig, auditActionConfig, questionTypeDisplayConfig, getReviewViewConfig } from '@/lib/lms/quiz-review-types';
